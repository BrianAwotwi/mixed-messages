...
adjective = ['Secret ', 'Big ', 'Shining ', 'Lustrous ', 'Violent ', 'Giga ', 'Super ', 'Mega ', 'Ultra ', 'Wild ', 'Hidden ', 'Fiery ', 'Icy ', 'Evil ', 'Virtuous ', 'Lovely '];
noun = ['Moon ', 'Water ', 'Fire ', 'Wind ', 'Wolf ', 'Tiger ', 'Elephant ', 'Venom ', 'Sun ', 'Mountain ', 'Rocket ', 'Mind ', 'Soul ', 'Earth ', 'Light ', 'Shadow ', 'Galaxy ', 'Storm '];
